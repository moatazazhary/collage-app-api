...
const {sgMail} = require('../../../configs/sendGridConfig')
//   
//   send mail with sendMailer service
// 
...
//   send mail with send grid service
const sendOTPMail = async (to,name,time,subject,otp)=>{
    try{
        await sgMail.send({
            to, 
        ...
        throw new Error(`Error while sending mail , Error : ${error}`)
    }
}
